  ...
  return (
    <div className="space-y-1.5">
      <div className="flex gap-2">
        <div className="bg-primary/20 h-0.5 w-1/2 rounded-full" />
      </div>
      <div className="flex gap-1">
        <div className="bg-primary/10 h-0.5 w-1/3 rounded-full" />
        <div className="bg-primary/10 h-0.5 w-1/3 rounded-full" />
      </div>
      <div className="flex gap-1">
        <div className="bg-primary/10 h-0.5 w-1/2 rounded-full" />
        <div className="bg-primary/10 h-0.5 w-1/3 rounded-full" />
      </div>
      <div className="flex gap-1">
        <div className="bg-primary/10 h-0.5 w-1/3 rounded-full" />
...
export const FileGraphic = ({ formatFile }: FileGraphicProps) => {
    ...
    filePlaceholder = (
      <div className="space-y-1.5">
        <div className="flex items-center gap-1">
          <div className="text-primary/30 text-[10px] font-bold">#</div>
          <div className="bg-primary/20 h-0.5 w-6 rounded-full" />
        </div>
        <div className="space-y-1">
          <div className="bg-primary/10 h-0.5 w-1/3 rounded-full" />
          <div className="bg-primary/10 h-0.5 w-7 rounded-full" />
        </div>
        <div className="space-y-1">
          <div className="bg-primary/10 h-0.5 w-8 rounded-full" />
          <div className="bg-primary/10 h-0.5 w-4 rounded-full" />
          <div className="bg-primary/10 h-0.5 w-1/3 rounded-full" />
        </div>
      </div>
    );
  ...
  if (formatFile === "csv") {
    filePlaceholder = (
      <>
        <div className="mb-2">
          <div className="grid grid-cols-3 gap-0.5">
            <div className="bg-primary/20 h-1.5 rounded-full" />
            <div className="bg-primary/20 h-1.5 rounded-full" />
            <div className="bg-primary/20 h-1.5 rounded-full" />
          </div>
        </div>
        <div className="space-y-1.5">
          <div className="grid grid-cols-3 gap-0.5">
            <div className="bg-primary/5 h-1 rounded-full" />
            <div className="bg-primary/5 h-1 rounded-full" />
            <div className="bg-primary/5 h-1 rounded-full" />
          </div>
          <div className="grid grid-cols-3 gap-0.5">
      ...
      <div className="relative flex h-full flex-col items-center justify-center">
        <div className="space-y-0">
          <div className="flex overflow-hidden rounded-full">
            <div className="bg-primary/20 size-1.5" />
            <div className="bg-primary/5 size-1.5" />
          </div>
          <div className="flex overflow-hidden rounded-full">
            <div className="bg-primary/5 size-1.5" />
            <div className="bg-primary/20 size-1.5" />
  ...
  if (formatFile === "ppt" || formatFile === "pptx") {
    filePlaceholder = (
      <>
        <div className="bg-primary/5 mb-1.5 space-y-1 rounded border p-1">
          <div className="flex justify-center gap-1">
            <div className="size-3 rounded-sm bg-orange-400/40" />
          </div>
          <div className="bg-primary/15 mx-auto h-0.75 w-8 rounded-full" />
        </div>
        <div className="mb-1 flex justify-center gap-1">
          <div className="bg-primary/15 h-0.75 w-8 rounded-full" />
          <div className="bg-primary/15 h-0.75 w-4 rounded-full" />
        </div>
        <div className="space-y-1">
          <div className="bg-primary/15 h-0.75 w-4 rounded-full" />
          <div className="bg-primary/15 h-0.75 w-5 rounded-full" />
        </div>
      </>
    );
  }
    ...
    filePlaceholder = (
      <>
        <div className="bg-primary/5 mb-1.5 space-y-1 rounded border p-1">
          ...
          <div className="bg-primary/15 mx-auto mt-1 h-0.75 w-4 rounded-full" />
          <div className="bg-primary/15 mx-auto h-0.75 w-8 rounded-full" />
        </div>
      </>
    );
    ...
    filePlaceholder = (
      <div className="space-y-1">
        <div className="flex items-center gap-0.5">
          <div className="text-primary/30 font-mono text-[5px]">&lt;</div>
  ...
  if (formatFile === "css") {
    filePlaceholder = (
      <div className="space-y-1">
        <div className="flex items-center gap-1">
          <div className="text-primary/40 font-mono text-[6px]">{"{"}</div>
        </div>
  ...
  if (formatFile === "json") {
    filePlaceholder = (
      <div className="space-y-1">
        ...
        <div className="flex items-center gap-1 pl-1.5">
          <div className="bg-primary/20 h-0.75 w-3 rounded-full" />
          <div className="bg-primary/20 h-0.75 w-4 rounded-full" />
        </div>
        <div className="flex items-center gap-1 pl-1.5">
          <div className="bg-primary/10 h-0.75 w-4 rounded-full" />
          <div className="bg-primary/10 h-0.75 w-2 rounded-full" />
        </div>
        <div className="flex items-center gap-1 pl-1.5">
          <div className="bg-primary/10 h-0.75 w-3 rounded-full" />
          <div className="bg-primary/10 h-0.75 w-4 rounded-full" />
        </div>
        <div className="flex items-center gap-1 pl-1.5">
          <div className="bg-primary/10 h-0.75 w-3 rounded-full" />
  ...
  return (
    <div aria-hidden className="relative size-fit">
      ...
      <div
        className={cn(
          "relative z-1 space-y-3 rounded-md p-2 border border-primary/20",
          "bg-primary/10 backdrop-blur-xl shadow-sm",
          sizeClass
        )}
      >
        {filePlaceholder}
