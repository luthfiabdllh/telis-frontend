...
export function AnalyticsDashboardContainer() {
  const { data: dashboardMetrics, isLoading: isLoadingDashboard, isError: isErrorDashboard } = useDashboardMetrics();
  ...
  return (
    <div className="flex flex-col space-y-6 w-full">
      ...
      {/* Main Charts Section */}
      <AnalyticsCharts metrics={dashboardMetrics || null} isLoading={isLoadingDashboard} />

      {/* Heatmap & Contracts Section */}
      <RiskAndContracts 
        heatmap={heatmap || []} 
